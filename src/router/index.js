    ...
    children: [
      {
        ...
        component: () =>
          import("@/views/HighriseBuildings/BuildingManagement/index.vue"),
      },
      {
        path: "jzwjc",
        meta: {
        ...
        component: () =>
          import("@/views/HighriseBuildings/CheckBuilding/index.vue"),
      },
      {
        path: "yhgl",
        meta: {
      ...
      },
      {
        ...
        component: () =>
          import("@/views/HighriseBuildings/EnterStatistics/index.vue"),
      },
    ],
  },
  {
